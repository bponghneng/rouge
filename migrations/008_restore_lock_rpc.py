"""
Restore get_and_lock_next_issue RPC function for atomic worker locking.

Re-creates the parameterized function signature that uses FOR UPDATE SKIP LOCKED
to prevent race conditions when multiple workers poll for issues simultaneously.
"""
