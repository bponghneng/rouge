...
def test_legacy_new_command_fails():
...
def test_legacy_run_command_fails():
...
def test_legacy_patch_command_fails():
...
def test_legacy_codereview_command_fails():
...
def test_legacy_read_command_fails():
...
def test_legacy_list_command_fails():
...
def test_legacy_update_command_fails():
...
def test_legacy_delete_command_fails():
...
def test_issue_command_group_exists():
...
def test_workflow_command_group_exists():
...
def test_comment_command_group_exists():
...
def test_step_command_group_exists():
...
def test_artifact_command_group_exists():
