...
@patch("rouge.core.workflow.steps.quality_step.emit_comment_from_payload")
@patch("rouge.core.workflow.steps.quality_step.execute_template")
...
@patch("rouge.core.workflow.steps.create_github_pr_step.shutil.which")
@patch("rouge.core.workflow.steps.create_github_pr_step.get_repo_path")
@patch("rouge.core.workflow.steps.create_github_pr_step.subprocess.run")
@patch("rouge.core.workflow.steps.create_github_pr_step.emit_comment_from_payload")
...
@patch("rouge.core.workflow.steps.create_gitlab_pr_step.get_repo_path")
@patch("rouge.core.workflow.steps.create_gitlab_pr_step.subprocess.run")
@patch("rouge.core.workflow.steps.create_gitlab_pr_step.emit_comment_from_payload")
...
@patch.dict("os.environ", {}, clear=True)
@patch("rouge.core.workflow.steps.create_gitlab_pr_step.emit_comment_from_payload")
@patch("rouge.core.workflow.steps.create_gitlab_pr_step.logger")
