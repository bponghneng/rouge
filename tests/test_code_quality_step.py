...
- Reads the implement data from context to get affected repo paths (optional dependency)
...
class TestCodeQualityOptionalDependency:
    ...
    def test_succeeds_without_implement_data(
        ...
        """CodeQualityStep succeeds even when no implement data exists in context."""
        mock_response = Mock()
        mock_response.success = True
