...
This module provides the OpenCode CLI integration for CAPE, allowing
...
class OpenCodeAgent(CodingAgent):
    ...
    - Directory structure conventions (.cape/logs/agents/{adw_id}/{agent_name}/)
        ...
        try:
            ...
            if request.output_path:
                ...
                agents_dir = os.environ.get(
                    "CAPE_AGENTS_DIR", os.path.join(os.getcwd(), ".cape/logs/agents")
                )
