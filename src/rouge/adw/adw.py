...
def execute_adw_workflow(
    ...
    *,
    ...
    # Validate that patch_mode is not used with codereview workflow
    if workflow_type == "codereview" and patch_mode:
        raise ValueError(
            "patch_mode cannot be used with workflow_type='codereview'. "
