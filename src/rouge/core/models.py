...
class Issue(BaseModel):
    ...
    Attributes:
        ...
        type: Issue type - 'full' for primary issues, 'patch' for patch
            issues, 'thin' for thin issues.
        adw_id: Agent Development Workflow identifier. Optional - will be
            auto-generated by create_issue if not supplied.
        branch: Optional branch name for issue work.
        assigned_to: Assignee identifier (free-text, e.g., email, agent name, or custom ID).
    ...
    type: Literal["full", "patch", "thin"] = "full"
