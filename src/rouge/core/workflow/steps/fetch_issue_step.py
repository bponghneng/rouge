...
class FetchIssueStep(WorkflowStep):
    ...
    def run(self, context: WorkflowContext) -> StepResult:
        ...
        try:
            ...
            # Store issue data in context for downstream steps
            context.data["fetch-issue"] = {"issue": issue}
            logger.debug("Stored fetch-issue data for workflow %s", context.adw_id)
