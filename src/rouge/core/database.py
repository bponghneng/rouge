...
def fetch_all_issues(
    ...
    Args:
        ...
        issue_type: Filter by issue type (e.g., 'full', 'patch', 'thin', 'direct')
...
def create_issue(
    ...
    Args:
        ...
        issue_type: Issue type - 'full' for primary issues, 'patch' for patch issues,
            'thin' for lightweight planned issues, and 'direct' for direct
            implementation issues. Defaults to 'full'.
...
def update_issue(
    ...
    *,
    ...
    Args:
        ...
        issue_type: Issue type ('full', 'patch', 'thin', or 'direct'), or UNSET to skip
